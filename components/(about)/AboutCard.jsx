...
export default function AboutCard() {
  ...
  return (
    <div className="bg-base-content border-info text-base-200 xs:mt-12 sm:mt-0 p-6 md:p-8 lg:p-10 2xl:p-12 3xl:p-16 border-[8px] rounded-3xl shadow-xl shadow-purple-800/50">
