export default function FunButton() {
  return (
    <div className='group relative mb-10 mt-10 inline-block text-lg'>
      ...
      <span
        className='absolute bottom-0 right-0 -mb-1 -mr-1 h-12 w-full rounded-lg bg-[#222] transition-all duration-200  ease-linear group-hover:mb-0 group-hover:mr-0 dark:bg-[#8F00FF]'
