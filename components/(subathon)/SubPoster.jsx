...
export default function SubPoster() {
  ...
  return (
    <div className=" bg-white rounded-3xl shadow-2xl p-3 shadow-purple-800/50 border-b-4 border-r-4 border-base-content">
      <div className="justify-center">
        <Link href="https://www.twitch.tv/sway_bae">
          <Image
            ...
            height={300}
            alt="Title"
            className="w-560 h-300 hover:scale-110  transition duration-300 ease-in-out"
          />
        </Link>
      </div>
