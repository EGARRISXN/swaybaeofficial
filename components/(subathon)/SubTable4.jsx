      ...
      <table className="table">
        <thead className="mx-auto">
          <tr className=" table-sm bg-base-content">
            ...
            <td className="text-lg  text-base-200">Community Games</td>
            <td className="text-lg  rounded-r-xl text-base-200">Co-Op Games</td>
          </tr>
        </thead>
        <tbody className="body">
          ...
          <tr className="hover table-xs">
            ...
            <td className="text-secondary text-xs">7 Days to Die</td>
          </tr>
          <tr className="hover table-xs">
            <td className="text-secondary text-xs">Animal Shelter</td>
          ...
          <tr className="hover table-xs">
            ...
            <td className="text-primary  text-xs">Jackbox Party Packs</td>
            <td className="text-secondary text-xs">Dead By Daylight</td>
          </tr>
          <tr className="hover table-xs">
            <td className="text-secondary text-xs">
          ...
          <tr className="hover table-xs">
            <td className="text-secondary text-xs">The Last Campfire</td>
            <td className="text-primary  text-xs">Super Smash</td>
            <td className="text-secondary text-xs">Sons of the Forest</td>
          </tr>
          <tr className="hover table-xs">
          ...
          <tr className="hover table-xs">
            <td className="text-secondary text-xs">Kindergarten 2</td>
          </tr>
          <tr className="hover table-xs">
            <td className="text-secondary text-xs">Only Up</td>
          </tr>
          <tr className="hover table-xs">
            <td className="text-secondary text-xs">The Oregon Trail</td>
          </tr>
          <tr className="hover table-xs">
          ...
          <tr className="hover table-xs">
            <td className="text-secondary text-xs">Animal Crossing</td>
          </tr>
          <tr className="hover table-xs">
            <td className="text-secondary text-xs">Zelda BOTW</td>
          </tr>
          <tr className="hover table-xs">
            <td className="text-secondary text-xs">Zelda Links Awakening</td>
          </tr>
          <tr className="hover table-xs">
            <td className="text-secondary text-xs">Luigis Mansion</td>
          </tr>
        </tbody>
      </table>
    </div>
