    ...
    <div className="overflow-x-auto shadow-lg rounded-br-2xl hover:bg-warning shadow-purple-800/50 p-2">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex justify-center z-50">
          ...
          <div className="modal-container flex justify-center max-w-lg mx-auto rounded shadow-lg z-50">
            <div className="modal-content text-left px-6">
              <div className="flex justify-between items-center pb-3">
                <button
                  className="modal-close btn btn-sm btn-primary cursor-pointer z-50"
                  onClick={closeModal}
                >
                  <svg
              ...
              <div className=" w-192 overflow-y-auto overflow-x-auto bg-base-200 border-base-content rounded-2xl  shadow-2xl border-4 shadow-purple-800/50 p-2">
                <table className="table table-xs">
                  <thead className="mx-auto">
                    <tr className=" table-sm bg-base-content">
                      ...
                      <th className="text-lg text-base-200">Community Games</th>
