...
export default function About() {
  return (
    <Animation>
      <main>
        <div className="flex flex-col-reverse justify-center my-16 md:flex-row px-5 md:px-10 md:space-x-8 lg:px-20 lg:space-x-10 xl:px-24 xl:space-x-12 2xl:space-x-14 3xl:space-x-16">
