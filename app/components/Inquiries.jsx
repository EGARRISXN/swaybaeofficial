'use client'
import ContactForm from '@/app/components/(inquiries)/ContactForm'
import ContactSocials from '@/app/components/(inquiries)/ContactSocials'
import MediaKitContainer from '@/app/components/(inquiries)/MediaKitContainer'
