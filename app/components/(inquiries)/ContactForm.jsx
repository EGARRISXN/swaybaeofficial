...
export default function ContactForm() {
  ...
  return (
    <form
      className='rounded-3xl border-4 border-base-content bg-base-200 px-4 pb-4 pt-4 text-base-content shadow-lg shadow-purple-800/50 sm:px-10 lg:px-12 lg:pt-8 xl:px-16 xl:pt-12 2xl:px-20'
      onSubmit={handleSubmit}
    >
      <div className='lobster mb-4 mt-4 text-4xl text-primary lg:mt-2 lg:text-6xl xl:mt-0'>
        Contact Me
      </div>
